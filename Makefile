...
SRCS = main.c lexer.c lex_handle.c lex_wd.c token.c utils.c lex_gram_check.c error_handle.c error_handle1.c \
	...
	exe_export.c exe_export1.c expan_hep1.c expan_hep2.c expan_hep3.c expan_hep4.c expan_hep5.c expansion.c utils_2.c\
	utils3.c redir1.c redir2.c redir3.c parser1.c parser2.c parser3.c parser4.c execute1.c execute2.c execute3.c\
	env.c env1.c env2.c status_utils.c exe_cmd.c exe_check_cmd.c
